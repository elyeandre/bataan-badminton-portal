...
let routes = (app, io) => {
  ...
  router.put(
    ...
    roleChecker(['admin']),
    (req, res, next) => {
      updateAdminAnnouncement(req, res);
    }
  );
  ...
  router.put('/admin/event/:eventId', verifyToken, roleChecker(['admin']), (req, res, next) => {
    updateAdminEvent(req, res);
  });
  ...
  router.put('/admin/settings/update-court-info', verifyToken, roleChecker(['admin']), updateCourtOwnerInfo);
  ...
  router.delete('/community/posts/:postId', verifyToken, roleChecker(['player', 'coach']), (req, res) => {
    removePost(req, res, io);
  });
  
  router.put('/community/posts/:postId', verifyToken, roleChecker(['player', 'coach']), (req, res) => {
    req.io = io;
    editPost(req, res);
  });
  ...
  router.put('/community/posts/:postId/comment/:commentId', verifyToken, roleChecker(['player', 'coach']), editComment);

  router.post('/community/posts/:postId/comment/:commentId/like', verifyToken, roleChecker(['player', 'coach']), likeComment);

  router.delete('/community/posts/:postId/comment/:commentId/like', verifyToken, roleChecker(['player', 'coach']), unlikeComment);
