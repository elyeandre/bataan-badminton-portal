...
async function handleFileUpload(
  ...
  // Special handling for post_images - make them public
  if (category === 'post_images') {
    fileDocument.isPublic = true;
    await assignFileAccess(fileDocument, userId, ['admin', 'coach', 'player', 'superadmin'], [userId]);
